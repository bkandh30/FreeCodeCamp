...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_percentage = round((country_earnings / country_population).max() * 100, 1)
    highest_earning_country = (country_earnings / country_population).idxmax()
